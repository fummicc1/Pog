...
internal enum Asset {
    ...
    internal static let secondaryBackgroundColor = ColorAsset(
    ...
    internal static let page1 = ImageAsset(name: "page1")
    internal static let page2 = ImageAsset(name: "page2")
    internal static let page3 = ImageAsset(name: "page3")
}
...
internal struct ImageAsset {
    ...
    internal var image: Image {
        let bundle = BundleToken.bundle
            ...
            let image =
                (bundle == .main)
                ? NSImage(named: name) : bundle.image(forResource: name)
        #elseif os(watchOS)
