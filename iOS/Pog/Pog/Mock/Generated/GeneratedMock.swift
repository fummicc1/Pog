...
public class StoreMock: Store {
    ...
    public var searchConfiguration: AnyPublisher<SearchConfiguration, Never> {
        return self.searchConfigurationSubject.eraseToAnyPublisher()
    }
    public private(set) var searchConfigurationSubject = PassthroughSubject<
        SearchConfiguration, Never
    >()

    public var logs: AnyPublisher<[PlaceLogData], Never> {
        return self.logsSubject.eraseToAnyPublisher()
    }
    ...
    { return self.interestingPlaceVisitingLogDatasSubject.eraseToAnyPublisher() }
    public private(set) var interestingPlaceVisitingLogDatasSubject = PassthroughSubject<
        [InterestingPlaceVisitingLogData], Never
    >()

    public var interestingPlaces: AnyPublisher<[InterestingPlaceData], Never> {
        return self.interestingPlacesSubject.eraseToAnyPublisher()
    }
    public private(set) var interestingPlacesSubject = PassthroughSubject<
        [InterestingPlaceData], Never
    >()

    public var locationSettings: AnyPublisher<LocationSettingsData?, Never> {
        return self.locationSettingsSubject.eraseToAnyPublisher()
    }
    public private(set) var locationSettingsSubject = PassthroughSubject<
        LocationSettingsData?, Never
    >()
    ...
    public var deleteWithBatchHandler: ((NSBatchDeleteRequest) throws -> Void)?
    ...
    public var updateSearchConfigurationHandler: ((Any, Any) -> Void)?
...
public class PlaceManagerMock: PlaceManager {
    ...
    public var placesPublisher: AnyPublisher<[Place], Never> {
        return self.placesPublisherSubject.eraseToAnyPublisher()
    }
    ...
    public var searchNearbyHandler: ((CLLocationCoordinate2D) -> Void)?
    ...
    public var searchHandler: ((String, CLLocationCoordinate2D?, Bool) async -> Void)?
    public func search(
        text: String,
...
public class LocationManagerMock: LocationManager {
    ...
    public init(
        ...
        currentAuthorizationStatus: CLAuthorizationStatus
    ) {
    ...
    public var isAuthorizedForPreciseLocation: AnyPublisher<Bool, Never> {
        return self.isAuthorizedForPreciseLocationSubject.eraseToAnyPublisher()
    }
    public private(set) var isAuthorizedForPreciseLocationSubject = PassthroughSubject<
        Bool, Never
    >()
    ...
    public var allowsBackgroundLocationUpdates: Bool = false {
        didSet { allowsBackgroundLocationUpdatesSetCallCount += 1 }
    }

    public private(set) var currentCoordinateSetCallCount = 0
    public var currentCoordinate: CLLocationCoordinate2D? = nil {
        didSet { currentCoordinateSetCallCount += 1 }
    }

    public var coordinate: AnyPublisher<CLLocationCoordinate2D, Never> {
        return self.coordinateSubject.eraseToAnyPublisher()
    }
    public private(set) var coordinateSubject = PassthroughSubject<
        CLLocationCoordinate2D, Never
    >()

    public private(set) var currentAuthorizationStatusSetCallCount = 0
    private var _currentAuthorizationStatus: CLAuthorizationStatus! {
        didSet { currentAuthorizationStatusSetCallCount += 1 }
    }
    ...
    public var authorizationStatus: AnyPublisher<CLAuthorizationStatus, Never> {
        return self.authorizationStatusSubject.eraseToAnyPublisher()
    }
    public private(set) var authorizationStatusSubject = PassthroughSubject<
    ...
    public var monitoringRegions: AnyPublisher<[CLRegion], Never> {
        return self.monitoringRegionsSubject.eraseToAnyPublisher()
    }
    ...
    public var onEnterRegion: AnyPublisher<CLCircularRegion, Never> {
        return self.onEnterRegionSubject.eraseToAnyPublisher()
    }
    public private(set) var onEnterRegionSubject = PassthroughSubject<
        CLCircularRegion, Never
    >()

    public var onExitRegion: AnyPublisher<CLCircularRegion, Never> {
        return self.onExitRegionSubject.eraseToAnyPublisher()
    }
    public private(set) var onExitRegionSubject = PassthroughSubject<
        CLCircularRegion, Never
    >()

    public private(set) var requestCallCount = 0
    public var requestHandler: (() -> Void)?
    public func request() {
        requestCallCount += 1
    ...
    public var updateLocationManagerHandler: ((Any, Any) -> Void)?
